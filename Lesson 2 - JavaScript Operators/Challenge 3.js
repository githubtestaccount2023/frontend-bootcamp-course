...
const expression1 = 100 % 50; // equals 0
const expression2 = 100 / 50; // equals 2
const expression3 = expression1 < expression2; //equals true
const expression4 = expression3 && 300 + 5 === 305; //equals true
const expression5 = !expression4; //equals false
...
We know that 100 / 50 is equal to 2 with no remainder, so this will evaluate to 0 (aka no remainder)*/
...
/* Now, we are combining two of our previous expressions. The first expression evaluated to 0 while the second evaluated to 2. 
So in this case, we are really asking what 0 < 2 evaluates to, which should be true (because 0 is less than 2)*/
...
First, we need to figure out what 300 + 5 is. This should equal 305. Now, we compare that result in the following expression: 305 === 305, which evalutes to true.
...
/*Like I said, in real-life, you would never try to combine this into one expression. You would want to break it out into separate variables so that when you go back to read your code months later, 
you don't have to spend 20 minutes trying to decrypt it
